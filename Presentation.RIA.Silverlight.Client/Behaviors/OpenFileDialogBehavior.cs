...
namespace Microsoft.Samples.NLayerApp.Presentation.Silverlight.Client.Behaviors
{
   ...
   public class OpenFileDialogBehavior : TargetedTriggerAction<Button>
   {
      ...
      public static readonly DependencyProperty DialogFilterProperty = DependencyProperty.Register(
         "DialogFilter",
         typeof (string),
         typeof (OpenFileDialogBehavior),
         null);
      ...
      public string DialogFilter
      {
         get
         {
            if (GetValue(DialogFilterProperty) == null) {
               return "JPEG Files (*.jpg;*.jpeg)|*.jpg;*.jpeg|" + "PNG Files (*.png)|*.png|All Files (*.*)|*.*";
            }
