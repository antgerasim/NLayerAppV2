      ...
      public override void Up()
      {
         CreateTable(
            ...
            c => new
            {
               ...
               RawPhoto = c.Binary(),
            }).PrimaryKey(t => t.Id).ForeignKey("Countries", t => t.CountryId).Index(t => t.CountryId);
         ...
         CreateTable(
            ...
            }).PrimaryKey(t => t.Id).ForeignKey("Customers", t => t.CustomerId).Index(t => t.CustomerId);
         ...
         CreateTable(
            ...
            }).PrimaryKey(t => t.Id).ForeignKey("Products", t => t.Id).Index(t => t.Id);
